...
from cera_agent.executor.core.task_runners import TaskManager
from executor.constants import TASK_TYPES_WITH_FILES
from executor.models.task import ExecutorTaskPayload, TaskTypeEnum
...
def build_parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(
        prog="task_runner",
        description="Execute a distributed compute task via TaskManager",
    )
    root.add_argument(
        "--payload",
        type=str,
